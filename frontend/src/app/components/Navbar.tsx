              ...
              {NAV_LINKS.filter((link) => {
                ...
                return (
                  <Link
                    key={link.href}
                    to={link.href}
                    className={`px-3.5 py-1.5 text-sm font-medium transition-all duration-200 relative ${isActive
                        ...
                        {notifications.length === 0 ? (
                          ...
                          notifications.map((n) => (
                            <div
                              ...
                              className={`flex items-start gap-3 p-3.5 transition-all cursor-pointer ${n.read ? "bg-transparent hover:bg-white/[0.03]" : "bg-blue-500/[0.06] hover:bg-blue-500/[0.1]"
                                }`}
                            >
